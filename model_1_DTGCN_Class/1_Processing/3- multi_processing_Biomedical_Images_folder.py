...
parser.add_argument('--folder_path', type=str, required=False,
                    default=f'{BASE_DIR}/model_1_DTGCN_Class/DTDataset_Class/AugmentedBenignImages/',
                    help='The folder Path to the folder containing images')
parser.add_argument('--output_folder_tri', type=str, required=False,
                    default=f'{BASE_DIR}/model_1_DTGCN_Class/DTDataset_Class/Graphs/1024/augmentedBenign/',
                    help='Destination folder for triangulations')
parser.add_argument('--output_folder_label', type=str, required=False, 
                    default=f'{BASE_DIR}/model_1_DTGCN_Class/DTDataset_Class/Graphs/1024/augmentedBenign/',
