...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 83), // void()(HEAP *, unsigned int *, unsigned int *, double *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 80), // HEAP *
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 8), // unsigned int *
/*  3 */ _CFFI_OP(_CFFI_OP_NOOP, 2),
/*  4 */ _CFFI_OP(_CFFI_OP_POINTER, 10), // double *
/*  5 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  6 */ _CFFI_OP(_CFFI_OP_FUNCTION, 83), // void()(HEAP *, unsigned int, unsigned int, double)
...
/* 12 */ _CFFI_OP(_CFFI_OP_FUNCTION, 83), // void()(double * *, int, int, int, int *, int *, int, double, double * *, double * *, double * *, double * * *, double *, double *)
...
/* 28 */ _CFFI_OP(_CFFI_OP_FUNCTION, 83), // void()(double *, double *, double *, double, double *, double *, double *)
...
/* 37 */ _CFFI_OP(_CFFI_OP_FUNCTION, 83), // void()(double *, int, int, int, int, double, int, int *, int *, double *, double *, double *, double *, int *, double *, double *)
...
/* 72 */ _CFFI_OP(_CFFI_OP_FUNCTION, 83), // void()(int, int, int, int *, int *, int *)
...
/* 80 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // HEAP
/* 81 */ _CFFI_OP(_CFFI_OP_POINTER, 82), // NODE *
/* 82 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 1), // NODE
/* 83 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 0), // void
};
...
static void _cffi_d_Delaunay_triangulation(int x0, int x1, int * x2, double * x3, double * x4, int x5, int * x6, int * x7, int * x8)
{
  Delaunay_triangulation(x0, x1, x2, x3, x4, x5, x6, x7, x8);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_Delaunay_triangulation(PyObject *self, PyObject *args)
{
  int x0;
  int x1;
  int * x2;
  ...
  if (!PyArg_UnpackTuple(args, "Delaunay_triangulation", 9, 9, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8))
    return NULL;
...
#else
#  define _cffi_f_Delaunay_triangulation _cffi_d_Delaunay_triangulation
#endif
...
static void _cffi_d_SNIC_main(double * x0, int x1, int x2, int x3, int x4, double x5, int x6, int * x7, int * x8, double * x9, double * x10, double * x11, double * x12, int * x13, double * x14, double * x15)
{
  SNIC_main(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_SNIC_main(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "SNIC_main", 16, 16, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10, &arg11, &arg12, &arg13, &arg14, &arg15))
    return NULL;
  ...
  datasize = _cffi_prepare_pointer_call_argument(
      _cffi_type(17), arg13, (char **)&x13);
  if (datasize != 0) {
    x13 = ((size_t)datasize) <= 640 ? (int *)alloca((size_t)datasize) : NULL;
    if (_cffi_convert_array_argument(_cffi_type(17), arg13, (char **)&x13,
            datasize, &large_args_free) < 0)
      return NULL;
  }
...
static void _cffi_d_boundary_detection(int * x0, int x1, int x2, int * x3)
{
  boundary_detection(x0, x1, x2, x3);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_boundary_detection(PyObject *self, PyObject *args)
{
  int * x0;
  int x1;
  int x2;
  ...
  if (!PyArg_UnpackTuple(args, "boundary_detection", 4, 4, &arg0, &arg1, &arg2, &arg3))
    return NULL;
...
#else
#  define _cffi_f_boundary_detection _cffi_d_boundary_detection
#endif
...
static void _cffi_d_runSNIC(double * * x0, int x1, int x2, int x3, int * x4, int * x5, int x6, double x7, double * * x8, double * * x9, double * * x10, double * * * x11, double * x12, double * x13)
{
  runSNIC(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_runSNIC(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "runSNIC", 14, 14, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8, &arg9, &arg10, &arg11, &arg12, &arg13))
    return NULL;
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "Delaunay_triangulation", (void *)_cffi_f_Delaunay_triangulation, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 61), (void *)_cffi_d_Delaunay_triangulation },
  { "FindSeeds", (void *)_cffi_f_FindSeeds, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 72), (void *)_cffi_d_FindSeeds },
  { "SNIC_main", (void *)_cffi_f_SNIC_main, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 37), (void *)_cffi_d_SNIC_main },
  { "boundary_detection", (void *)_cffi_f_boundary_detection, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 55), (void *)_cffi_d_boundary_detection },
  ...
  { "rgbtolab", (void *)_cffi_f_rgbtolab, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 28), (void *)_cffi_d_rgbtolab },
